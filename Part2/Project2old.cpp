...
// Date : Fall 2017
// Description : This program attempts to predict the type of document using probabilities. This project is probably 80% complete, not for lack of trying.
...
int main()
{
  ...
  // ifstream input1("ShakespeareData_train_90.txt");//doc1
  if (input1.fail()) {
  ...
  while (getline(input1, storage1)) {
   ...
   // ifstream input2("ElizabethanData_train_90.txt");//doc1
  if (input2.fail()) {
  ...
  while (getline(input2, storage2)) {
   ...
   // ifstream input3("ShakespeareData_test_90.txt");//doc1
  if (input3.fail()) {
  ...
  while (getline(input3, storage3)) {
   ...
   // ifstream input4("ElizabethanData_test_90.txt");//doc1
  if (input4.fail()) {
 ...
 cout<<"Total sonnet in " << file3 << " are: "<<total3<<endl;
  cout<<"Classification accuracy (" <<guessShake<<"/"<<total3<<")"<<endl;
  cout<<"Total sonnet in " << file4 << " are: "<<total4<<endl;
  cout<<"Classification accuracy (" <<guessEliza <<"/"<<total4<<")"<<endl;
  cout<<endl;
  cout<<"Combined Classification accuracy ("<<guessShake+guessEliza<<"/"<<total3+total4<<") = "<<endl;
